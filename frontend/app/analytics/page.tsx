                    ...
                    <CardContent className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={productData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                          ...
                          <XAxis dataKey="product_id" />
                          <YAxis />
                          <Tooltip labelFormatter={(id) => `Product #${id}`} />
                          <Legend />
                    ...
                    <CardContent className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          ...
                          <Tooltip formatter={(value) => `$${value}`} labelFormatter={(id) => `Product #${id}`} />
                          <Legend formatter={(value, entry) => `Product #${value}`} />
                        </PieChart>
                      </ResponsiveContainer>
                    </CardContent>
                  </Card>
                  ...
                  <CardContent className="h-[400px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={customerData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                        ...
                        <YAxis />
                        <Tooltip formatter={(value) => `$${value}`} labelFormatter={(id) => `Customer #${id}`} />
                        <Legend />
                    ...
                    <CardContent className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={customerData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                          ...
                          <XAxis dataKey="customer_id" />
                          <YAxis />
                          <Tooltip labelFormatter={(id) => `Customer #${id}`} />
                          <Legend />
                  ...
                  <CardContent className="h-[400px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={supplierData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                        ...
                        <YAxis />
                        <Tooltip labelFormatter={(id) => `Supplier #${id}`} />
                        <Legend />
                    ...
                    <CardContent className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          ...
                          <Tooltip formatter={(value) => `$${value}`} labelFormatter={(id) => `Supplier #${id}`} />
                          <Legend formatter={(value, entry) => `Supplier #${value}`} />
                        </PieChart>
                      </ResponsiveContainer>
                    </CardContent>
                  </Card>
